...
# 'convnext_xxlarge.clip_laion2b_soup_ft_in1k' 'eva02_large_patch14_448.mim_m38m_ft_in22k_in1k'



# # iwildcamo models:
# 'iwildcam_afn_extraunlabeled_tune0' 'iwildcam_dann_coarse_extraunlabeled_tune0' 'iwildcam_deepcoral_coarse_extraunlabeled_tune0' \ 
# 'iwildcam_deepcoral_coarse_singlepass_extraunlabeled_tune0' 'iwildcam_deepCORAL_seed0' 'iwildcam_deepCORAL_seed1' 'iwildcam_deepCORAL_seed2' \ 
# 'iwildcam_deepCORAL_tune' 'iwildcam_ermaugment_tune0' 'iwildcam_ermoracle_extraunlabeled_tune0' 'iwildcam_erm_seed0' 'iwildcam_erm_seed1' \
...
# 'iwildcam_erm_tuneE_seed0' 'iwildcam_erm_tuneF_seed0' 'iwildcam_erm_tuneG_seed0' 'iwildcam_erm_tuneH_seed0' 'iwildcam_fixmatch_extraunlabeled_tune0' \ 
# 'iwildcam_groupDRO_seed0' 'iwildcam_groupDRO_seed1' 'iwildcam_groupDRO_seed2' 'iwildcam_irm_seed0' 'iwildcam_irm_seed1' 'iwildcam_irm_seed2' 'iwildcam_irm_tune' \ 
# 'iwildcam_noisystudent_extraunlabeled_seed0' 'iwildcam_pseudolabel_extraunlabeled_tune0' 'iwildcam_swav30_ermaugment_seed0' 

# 'iwildcam_erm_seed1' 'iwildcam_deepCORAL_seed0' 'iwildcam_groupDRO_seed0' 'iwildcam_irm_seed0'\
# 'iwildcam_erm_tune0' 'iwildcam_ermaugment_tune0' 'iwildcam_ermoracle_extraunlabeled_tune0' 'iwildcam_swav30_ermaugment_seed0' \
# 'iwildcam_dann_coarse_extraunlabeled_tune0' 'iwildcam_afn_extraunlabeled_tune0'
...
# "cifar10_mobilenetv2_x0_5" "cifar10_mobilenetv2_x0_75" "cifar10_mobilenetv2_x1_0" "cifar10_mobilenetv2_x1_4" "cifar10_repvgg_a0" "cifar10_rhtopepvgg_a1" \ "cifar10_repvgg_a2" "cifar10_resnet20" "cifar10_resnet32" "cifar10_resnet44" "cifar10_resnet56" "cifar10_shufflenetv2_x0_5" "cifar10_shufflenetv2_x1_0" \
# "cifar10_shufflenetv2_x1_5" "cifar10_shufflenetv2_x2_0" "cifar10_vgg11_bn" "cifar10_vgg13_bn" "cifar10_vgg16_bn" "cifar10_vgg19_bn"


#'tv_resnet152' 'beit_base_patch16_384'
# all_model_names=('lcnet_050' 'tv_resnet34' 'tv_resnet50' 'tv_resnet101' 'tv_resnet152' 'densenet121' 'inception_v4' 'resnet26d' 'mobilenetv2_140' 'hrnet_w40' \
# 'xception' 'xception41' 'resnet18' 'resnet34' 'seresnet50' 'mobilenetv2_050' 'seresnet33ts' 'wide_resnet50_2' 'wide_resnet101_2' 'resnet18d' \
# 'hrnet_w18_small' 'gluon_resnet152_v1d' 'hrnet_w48'  'hrnet_w44'  'repvgg_b2'  'densenet201'  'hrnet_w18_small'  'resnet101d' 'gluon_resnet101_v1d' \
# 'gluon_resnet101_v1s' 'gluon_xception65' 'gluon_seresnext50_32x4d' 'gluon_senet154' 'gluon_inception_v3' 'gluon_resnet101_v1c' 'tf_inception_v3' \
# 'tv_densenet121' 'tv_resnext50_32x4d' 'repvgg_b1g4' 'resnext26ts' 'ghostnet_100' 'crossvit_9_240' 'deit_base_patch16_384' 'rexnet_150' 'rexnet_130' \
...
# 'vgg11' 'vgg11_bn' 'vgg16' 'vgg19' 'swin_small_patch4_window7_224' 'swin_base_patch4_window12_384' 'deit_base_patch16_224' \
# 'deit_small_distilled_patch16_224' 'densenet161' 'tf_mobilenetv3_large_075' 'inception_v3')
all_model_names=('beit_base_patch16_384')
...
for m_name in ${all_model_names[@]}
  do
  echo $m_name
  OMP_NUM_THDS=20 CUDA_VISIBLE_DEVICES=6,7 python test_savePredictions3.py --job_id $job_id --model_name $m_name --label_path 'list_patition_label.txt' --mode test --data_root datasets/celebA --gpu_ids 0,1 --ckpt_dir ../models/ganimation/190327_160828/ --load_epoch 30 --batch_size_fer 128 --set_portion 1 --out_dir imagenet_a_out_rotation_May24
  done
