...
def main(args):
    ...
    if model_name == 'iwildcam_erm_tuneE_seed0':
        model2_name = 'iwildcam_erm_tuneF_seed0'
    else:
        model2_name = 'iwildcam_erm_tuneE_seed0'

    
    grey_prediction_path1 = '/root/paddlejob/workspace/env_run/afs/liuyuchi/autoEval/modelOutput/iwildcam_out_rotation/%s.npy'%(model_name+'_best')
    grey_prediction_path2 = '/root/paddlejob/workspace/env_run/afs/liuyuchi/autoEval/modelOutput/iwildcam_out_rotation/%s.npy'%(model2_name+'_best')
    ...
    log_dir = os.path.join("/root/paddlejob/workspace/env_run/output/", "iwildcam_out_rotation_Apr10")
    ...
    DoC_source_path = '/root/paddlejob/workspace/env_run/afs/liuyuchi/autoEval/DoC/iwildcam_idval_AC/%s.npy'%(model_name+'_best')
    ATC_source_path = '/root/paddlejob/workspace/env_run/afs/liuyuchi/autoEval/ATC/iwildcam_idval_ATC/%s.npy'%(model_name+'_best')
    ...
    test_acc, DoC_acc, DoC_vrp_acc, ATC_acc, ATC_vrp_acc, predict_Inv, predict_Inv_vrp, confidence_Inv, confidence_Inv_vrp, AC, AC_vrp, wj_score, EI_randomPair, EI_vrm_1, EI_vrm_2, EI_vrm_all, vrm_pairs_1, vrm_pairs_all = test_wj(wj_test_loader, exter_knowledge_dic, device)
    ...
    np.save(os.path.join(log_dir ,model_name+'_best'+'.npy'), dic)
