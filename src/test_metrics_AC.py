...
def main(args):
    ...
    if model_name == 'tv_resnet50':
        model2_name = 'tv_resnet101'
    else:
        model2_name = 'tv_resnet50'

    grey_prediction_path1 = '/home/liuyc/calibration/modelOutput/imagenet_val_out_rotation/%s.npy'%(model_name)
    grey_prediction_path2 = '/home/liuyc/calibration/modelOutput/imagenet_val_out_rotation/%s.npy'%(model2_name)
    ...
    log_dir = os.path.join("../output/", "imagenet_val_test_AC")
