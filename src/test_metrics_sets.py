...
def main(args):
    ...
    npy_name = dataset_name+'_'+hard_level

    mixup_prediction_path1 = '/root/paddlejob/workspace/env_run/afs/liuyuchi/autoEval/data-centric/tf_efficientnet_b2_mixup/%s.npy'%(npy_name)

    grey_prediction_path1 = '/root/paddlejob/workspace/env_run/afs/liuyuchi/autoEval/data-centric/tf_efficientnet_b2_rotation/%s.npy'%(npy_name)

    test_dataset = ImageNetPredictions(args.ImageNetV2_path, mixup_prediction_path1, mixup_prediction_path1, type='mixup')                         
    wj_test_dataset = ImageNetPredictions(args.ImageNetV2_path, grey_prediction_path1, grey_prediction_path1, type='grey')      
    ...
    log_dir = os.path.join("/root/paddlejob/workspace/env_run/output/", "tf_efficientnet_b2_rotation_V2")
    ...
    np.save(os.path.join(log_dir ,npy_name+'.npy'), dic)
