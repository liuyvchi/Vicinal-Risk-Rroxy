...
def main(args):
    ...
    grey_prediction_path1 = '/root/paddlejob/workspace/env_run/afs/liuyuchi/autoEval/modelOutput/cifar10_GaussianBlur3_test_out_rotation//%s.npy'%(model_name)
    grey_prediction_path2 = '/root/paddlejob/workspace/env_run/afs/liuyuchi/autoEval/modelOutput/cifar10_GaussianBlur3_test_out_rotation/%s.npy'%(model2_name)
    ...
    log_dir = os.path.join("/root/paddlejob/workspace/env_run/output/", "cifar10_gaussianblur3_out_rotation_May15")
    ...
    DoC_source_path = '/root/paddlejob/workspace/env_run/afs/liuyuchi/autoEval/DoC/cifar10_test_AC/%s.npy'%(model_name)
    ATC_source_path = '/root/paddlejob/workspace/env_run/afs/liuyuchi/autoEval/ATC/cifar10_test_ATC/%s.npy'%(model_name)
