...
# 'hrnet_w18_small' 'gluon_resnet152_v1d' 'hrnet_w48'  'hrnet_w44'  'repvgg_b2'  'densenet201' 'resnet101d' 'gluon_resnet101_v1d' \
...
all_model_names=('iwildcam_erm_tuneE_seed0' 'iwildcam_erm_tuneF_seed0' 'iwildcam_erm_tuneG_seed0' 'iwildcam_erm_tuneH_seed0' 'iwildcam_fixmatch_extraunlabeled_tune0' \ 'iwildcam_groupDRO_seed0' 'iwildcam_groupDRO_seed1' 'iwildcam_groupDRO_seed2' 'iwildcam_irm_seed0' 'iwildcam_irm_seed1' 'iwildcam_irm_seed2' 'iwildcam_irm_tune' \ 'iwildcam_noisystudent_extraunlabeled_seed0' 'iwildcam_pseudolabel_extraunlabeled_tune0' 'iwildcam_swav30_ermaugment_seed0')
...
for m_name in ${all_model_names[@]}
  do
  echo $m_name
  OMP_NUM_THDS=20 CUDA_VISIBLE_DEVICES=0,1,2,3 python test_savePredictions_wilds.py --job_id $job_id --model_name $m_name --label_path 'list_patition_label.txt' --mode test --data_root datasets/celebA --gpu_ids 0,1,2,3 --ckpt_dir ../models/ganimation/190327_160828/ --load_epoch 30 --batch_size_fer 128
  done
