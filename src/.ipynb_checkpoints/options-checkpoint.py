...
class Options(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--model', type=str, default='ganimation', help='[ganimation|stargan], see model_ganimation.__init__ from more details.')
        ...
        parser.add_argument('--n_threads', type=int, default=8, help='number of workers to load data.')
        ...
        parser.add_argument('--epoch_count', type=int, default=1, help='the starting epoch count, we save the model_ganimation by <epoch_count>, <epoch_count>+<save_latest_freq>, ...')
        ...
        # FER regared options
        parser.add_argument('--ImageNetV2_path', type=str, default='../../data/imagenet-a', help='raf_dataset_path')
        parser.add_argument('--set_portion', type=float, default=1, help='set portion')
        parser.add_argument('--out_dir', type=str, default='./out_dir', help='set out dir')
        parser.add_argument('--raf_path', type=str, default='../../data/raf-basic', help='raf_dataset_path')
        parser.add_argument('--AffectNet_path', type=str, default='../../data/AffectNet/', help='raf_dataset_path')
        parser.add_argument('--MaEX_folder_path', type=str, default='../../data/MS1M128_macro7_AffectNetAU/', help='MaEX_path')
        parser.add_argument('--resnet50_path', type=str, default='../model_ganimation/ms1mv3_r18_backbone.pth',
                            help='pretrained_backbone_path')
        parser.add_argument('--label_path', type=str, default='list_patition_label.txt', help='label_path')
        # parser.add_argument('--MaEX_folder_path', type=str, default='/home/yuchi/micro-expression/ganimation_replicate/output/generated5k_macro7_expAUnew/', help='MaEX_path')
        parser.add_argument('--workers', type=int, default=32, help='number of workers')
        parser.add_argument('--batch_size_fer', type=int, default= 5000, help='batch_size')
        ...
        parser.add_argument('--gpu_ids_fer', type=str, default='0,1', help='the number of the device')
        parser.add_argument('--lam', type=float, default=5, help='kl_lambda')
        parser.add_argument('--epochs', type=int, default=20, help='number of epochs')
        parser.add_argument("--local_rank", type=int, default=0, help="local_rank")
        parser.add_argument("--use_raw_imgs", type=bool, default=False, help="train without generated images")
        parser.add_argument("--model_name", type=str, default=' ', help="model name in timm")
        parser.add_argument("--job_id", type=str, default=' ', help="job id in paddle")

        ### DaGAN
        parser.add_argument("--checkpoint_DaGAN", default='./DaGAN/DaGAN_vox_adv_256.pth.tar', help="path to checkpoint to restore")
        parser.add_argument("--config_DaGAN", default='./DaGAN/config/vox-adv-256.yaml', help="path to checkpoint to restore")
