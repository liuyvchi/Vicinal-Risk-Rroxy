...
def main(args):
    ...
    rotation_prediction_path1 = './output/iwildcam_val_out_rotation/%s.npy'%(model_name+'_'+best_or_last)
    ...
    ## iwildcaom
    model_string = model_name+'_'+best_or_last+'.pth'
    checkpoint_folder_path = '/home/liuyc/vicinal/iwildcam_weights'
    files = os.listdir(checkpoint_folder_path)

    for file in files:
        # print(model_string, file)
    ...
    args.ImageNetV2_path = '/home/liuyc/data/iwildcam_v2.0/train'        
    ...
    log_dir = os.path.join("../modelOutput", "iwildcam_idval_out_colorjitter")
